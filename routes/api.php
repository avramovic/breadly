...
Route::post('{table}/edit', ['as' => 'api.table.edit', 'uses' => 'Api\\BreadController@edit']);
Route::post('{table}/add', ['as' => 'api.table.add', 'uses' => 'Api\\BreadController@add']);
Route::post('{table}/delete', ['as' => 'api.table.delete', 'uses' => 'Api\\BreadController@delete']);
Route::post('{table}/delete/force', ['as' => 'api.table.delete.force', 'uses' => 'Api\\BreadController@forceDelete']);
