...
//        $categoryDataType = DataType::where('slug', 'categories')->firstOrFail();
    ...
    \"upload\": {
        ...
        $dataRow = $this->dataRow($taskDataType, 'name');
        if (!$dataRow->exists) {
            $dataRow->fill([
                'type'         => 'text',
                'display_name' => 'Name',
        ...
        $dataRow = $this->dataRow($taskDataType, 'created_at');
        if (!$dataRow->exists) {
            $dataRow->fill([
                'type'         => 'timestamp',
                'display_name' => 'created_at',
        ...
        $dataRow = $this->dataRow($taskDataType, 'updated_at');
        if (!$dataRow->exists) {
            $dataRow->fill([
                'type'         => 'timestamp',
                'display_name' => 'updated_at',
        ...
        $dataRow = $this->dataRow($taskDataType, 'image');
        if (!$dataRow->exists) {
            $dataRow->fill([
                'type'         => 'image',
                'display_name' => 'Image',
    ...
    \"upload\": {
        ...
        $dataRow = $this->dataRow($taskDataType, 'is_done');
        if (!$dataRow->exists) {
            $dataRow->fill([
                'type'         => 'checkbox',
